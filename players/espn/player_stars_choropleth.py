...
fig = ff.create_choropleth(fips=list_fips, values=list_values, legend_title="Aggregate ESPN Recruit Stars", title="Average Stars per Player per County 2006-2018")
